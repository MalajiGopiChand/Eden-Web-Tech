...
export default function AboutSection() {
  return (
    <section id="about" className="py-12 sm:py-16 bg-transparent border-y border-border/60 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-10 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-foreground tracking-tight mb-2.5 leading-[1.15]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6 mb-10 sm:mb-12">
                ...
                <div className="flex-1 min-w-0 pt-0.5">
                  ...
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-emerald-600 hover:text-white text-foreground transition-all text-xs font-bold shadow-xs"
                    >
                      <span>WhatsApp</span>
                      <ArrowUpRight size={13} />
                    </a>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
            {studioPillars.map((pillar) => {
              ...
              return (
                <div 
                  key={pillar.id}
                  className="p-5 rounded-2xl bg-white border border-border/70 hover:border-primary/40 transition-all duration-300 shadow-xs hover:shadow-sm flex flex-col justify-between"
                >
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <div className="w-9 h-9 rounded-xl bg-blue-50 text-primary flex items-center justify-center shadow-xs">
                        <Icon size={18} />
                      </div>
